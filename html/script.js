...
fetch('donnees_meteo.json')
    ...
    .then(data => {
        ...
        console.log(data)
        document.getElementById("airport_name2").textContent = data.airport_name || "Non disponible";
        document.getElementById("temperature_max2").textContent = data.temperature_max || "Non disponible";
        document.getElementById("temperature_min2").textContent = data.temperature_min || "Non disponible";
